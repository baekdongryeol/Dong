...
=> 회원가입, 로그인, 앱 만들기 , 앱키 받고(Javascript 키 copy 하기) , 플랫폼 등록(앱키 아랫쪽에 있음)
=> Javascript 키 : 6eab7e540c63cc902e58d714fe462eb2 (적용)
=> http://apis.map.kakao.com/web/sample/ 
-->	
<script type="text/javascript" 
	    src="//dapi.kakao.com/v2/maps/sdk.js?appkey=6eab7e540c63cc902e58d714fe462eb2&libraries=services">
</script>	
